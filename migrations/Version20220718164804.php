 ...
 */
final class Version20220718164804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE competent_job (competent_id INT NOT NULL, job_id INT NOT NULL, INDEX IDX_C5B96B34B0C570B7 (competent_id), INDEX IDX_C5B96B34BE04EA9 (job_id), PRIMARY KEY(competent_id, job_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
